public class DSA026array {
    public static void main(String args[])
    {
        ...
        System.out.println("Maximum Profit = "+ maxProfit(price, price.length));
    }
	...
	static int maxProfit(int price[], int n)
	{
		...
		for (int i = n - 2; i >= 0; i--) {
		    ...
		    //We can get profit[i] by taking maximum of: a) previous maximum, i.e.,
            // profit[i+1] b) profit by buying at price[i] and selling at max_price
